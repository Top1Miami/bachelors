...
class MelifLossFMeta:
    ...
    def __get_candidates(self, point, delta=0.1):
        ...
        # print(type(tiled_points))
        # print(tiled_points)
        # print()
        # print(type(tiled_points.tolist()[0]))
        # print(list(tiled_points))
        # print()
        # print([[1, 1, 1, 1]] + list(tiled_points))
